...
export const handler = async (event) => {
    ...
    for (const record of event.Records) {
        try {
            ...
            // TODO: Je Event eine Datei unter //s3-staging/raw-events/<eventId>.json
            // Über jedes Event iterieren
            // Erzeugen des S3-Bucket-Item Keys
            // Raw-Event Objekt erstellen: Body => JSON.stringify(event)
            // Je Event eine Datei unter raw-events/<eventId>.json
